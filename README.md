...
- [Network File System (NFS)](#network-file-system-nfs)
  ...
  - [Setup \& Running](#setup--running)
    - [1. Build Components](#1-build-components)
    - [2. Start Servers](#2-start-servers)
    - [3. Start Client](#3-start-client)
    - [4. Alternative Manual Execution](#4-alternative-manual-execution)
    - [5. Clean Backups](#5-clean-backups)
    - [6. Clean Build Files](#6-clean-build-files)
...
- **Storage Server:**
  ...
  ```
  Example: `./storage_server 127.0.0.1 /home/nitin/nfs_storage`
